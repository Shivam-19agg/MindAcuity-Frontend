    ...
    return (
        <div className="wave-container"
            style={{
                ...
                pointerEvents: 'none',
                background: 'radial-gradient(circle at 50% 30%, #F9FEFF 0%, #E0F2FE 100%)',
                overflow: 'hidden'
            }}>
            ...
            <div style={{
                ...
                <svg viewBox="0 0 1440 320" preserveAspectRatio="none" style={{ width: '100%', height: '100%', fill: '#BAE6FD' }}>
                    {/* Darker Blue for visibility: Sky 200 */}
            ...
            <div style={{
                ...
                <svg viewBox="0 0 1440 320" preserveAspectRatio="none" style={{ width: '100%', height: '100%', fill: '#7DD3FC' }}>
                    {/* Sky 300 */}
            ...
            <div style={{
                ...
                <svg viewBox="0 0 1440 320" preserveAspectRatio="none" style={{ width: '100%', height: '100%', fill: '#38BDF8' }}>
                    {/* Sky 400 */}
